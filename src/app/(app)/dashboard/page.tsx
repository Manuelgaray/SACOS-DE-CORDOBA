...
import { AREA_LABELS, AREA_COLORS, formatDateShort, type OrderStatus } from '@/lib/mock-data';
                ...
                return (
                  <div key={orden.id} className="px-4 py-3">
                    <div className="flex items-start justify-between gap-2 mb-2">
                      ...
                      <EstadoSelect value={est} onChange={(v) => setEstado(orden.id, v)} />
                    </div>
...
function EstadoSelect({ value, onChange }: { value: OrderStatus; onChange: (v: OrderStatus) => void }) {
