...
import { siguienteNumeroOrden } from '@/lib/orden-num';
import { elementosDesdePlantilla, calcularExplosion, type ElementoCorte } from '@/lib/explosion';
import {
  TablaCorteEditable,
  ResultadosExplosion,
  TextoLeido,
  ...
  nuevaFila,
  mensajeLectura,
} from '@/components/ExplosionMateriales';
...
export default function NuevaOrdenPage() {
  ...
  // Autocompletado: clientes ya trabajados.
  ...
  // Autocompletado: specs (diseños) previos; prioriza los del cliente capturado.
