...
import { elementosDesdePlantilla } from './explosion';
import { parseMedidas, normalizarTexto } from './corte-parse';
import type { ElementoCorte, GrupoCorte } from './mock-data';
...
const DETECTABLES: { claves: string[]; el: ElementoCorte }[] = [
  ...
  { claves: ['cordel', 'amarre', 'lazo'],        el: mk('Cordeles', 1, 'cintas') },
  { claves: ['cinta'],                           el: mk('Cintas', 1, 'cintas') },
